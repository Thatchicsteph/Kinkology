...
export default function GuestControl() {
  ...
  if (phase === "waiting") {
    ...
    return (
      <Shell code={code}>
        <div className="flex-1 flex flex-col gap-5" data-testid="waiting-state">
          <ObsStream />
          <div className="hud-panel px-8 py-10 w-full text-center">
            ...
            <p className="font-mono-data font-extrabold text-6xl text-[var(--kink-purple)] text-glow-purple mt-3" data-testid="queue-position">#{pos}</p>
    ...
    <Shell code={code}>
      <div className="fade-up space-y-4">
        ...
        <div className="hud-panel p-6 flex flex-col items-center">
          ...
          {!snap.host_connected && (
            <p className="font-mono-data text-xs text-[var(--kink-danger)] mt-3">⚠ Device host offline — commands may not apply</p>
          )}
        </div>
