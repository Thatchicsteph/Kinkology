      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <section className="space-y-6">
          ...
          <div className="hud-panel p-5 sm:p-6" data-testid="overlay-link-card">
            ...
            <p className="font-mono-data text-[11px] text-[var(--kink-muted)] mt-3">Tip: append <span className="text-[var(--kink-text-2)]">?transparent=1</span> for a transparent OBS background.</p>
          </div>
